...
//import model.mk.ukim.finki.emt.lab.Book;
//import selenium.mk.ukim.finki.emt.lab.AbstractPage;
//import selenium.mk.ukim.finki.emt.lab.AddOrEditForm;
//import selenium.mk.ukim.finki.emt.lab.ItemsPage;
//import selenium.mk.ukim.finki.emt.lab.LoginPage;
//import service.mk.ukim.finki.emt.lab.AuthorService;
//import service.mk.ukim.finki.emt.lab.BookService;
...
//        List<Book> entities = this.bookService.listAll();
...
////    @Order(3)
////    @Test
////    public void test_filter_bookService_5pt() {
////        SubmissionHelper.startTest("test-filter-bookService-5");
////
////        ExamAssert.assertEquals("without filter", 10, this.bookService.filter(null, null).size());
////        ExamAssert.assertEquals("by skill", 4, this.bookService.filter(1L, null).size());
////        ExamAssert.assertEquals("by years of bookService", 4, this.bookService.filter(null, 3).size());
////        ExamAssert.assertEquals("by all", 3, this.bookService.filter(1L, 1).size());
////
////        SubmissionHelper.endTest();
////    }
//
...
//        List<Skill> skills = this.skillbookService.listAll();
//        List<Employee> entities = this.bookService.listAll();
//
//        int itemNum = entities.size();
...
//        List<Skill> categories = this.skillbookService.listAll();
//        List<Employee> employees = this.bookService.listAll();
//
...
//
//        employees = this.bookService.listAll();
...
//                .andExpect(MockMvcResultMatchers.redirectedUrl(LIST_URL));
//
//        entities = this.bookService.listAll();
